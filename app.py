...
def calculoCurtoPrazo():
    ...
    quantas = dadosCurto["quantas"]
    tempodeuso = dadosCurto["tempodeuso"]
    num_dias = dadosCurto["num_dias"]
...
def calculoMedioPrazo():
    ...
    potencia = dadosMedio["potencia"]
    tempodeuso = dadosMedio["tempodeuso"]
    n_dias = dadosMedio["n_dias"]
...
def calculoLongoPrazo():
    ...
    valor_conta_mes = dadosLongo["valor_conta_mes"]
